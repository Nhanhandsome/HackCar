...
#define CONFIG_MB_UART_RXD 21
#define CONFIG_MB_UART_RTS 17
#define CONFIG_MB_UART_SE 19
...
void app_modbus_init()
{
    ...
    reg_area.start_offset = usMBHoldingStartReg; // Offset of register area in Modbus protocol
    reg_area.address = (void*)&holding_reg_params.data[0]; // Set pointer to storage instance
    // Set the size of register storage instance = 150 holding registers
    reg_area.size = sizeof(uint16_t) * usMBHoldingNRegs;
    ESP_ERROR_CHECK(mbc_slave_set_descriptor(reg_area));


    // Initialization of Input Registers area
    reg_area.type = MB_PARAM_INPUT;
    reg_area.start_offset = usMBInputStartReg;
    reg_area.address = (void*)&input_reg_params.data[0];
    reg_area.size = sizeof(uint16_t) * usMBInputNRegs;
    ESP_ERROR_CHECK(mbc_slave_set_descriptor(reg_area));
